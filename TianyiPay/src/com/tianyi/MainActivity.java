...
public class MainActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(UIResource.getLayoutResIDByName(getApplicationContext(),"activity_main"));
	...
	private TianyiPayCallback getTianyiPayCallback()
	{
		TianyiPayCallback tianyiPayCallback = new TianyiPayCallback() {
			...
			{
				//Tool.showToast(handler, MainActivity.this, "通知cp-支付成功");
			}
			
			@Override
			public void handFail(String orderid)
			{
				//Tool.showToast(handler, MainActivity.this, "通知cp-支付失败");
			}
		};
